...
//           thumbnail,
//           discountPercentage
//         //   images,7vpC_Sx9OaIZ1u3VZ2R7V0fJfsG8Pv56gmMtEIkfQsA
//         };

//         console.log(data)
//         // const valnameData = AddProductSchema.parse(FormData);
...
//                     <div className="mb-4">
//                         <label htmlFor="title" className="block text-sm font-semibold">Title</label>
//                         <input type="text" name="title" required  className="addProduct" />
                       
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="description" className="block text-sm font-semibold">Description</label>
//                         <textarea name="description" required className="addProduct pt-2"></textarea>
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="price" className="block text-sm font-semibold">Price</label>
//                         <input type="number" required name="price" className="addProduct" />
             
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="discountPercentage" className="block text-sm font-semibold">Discount Percentage</label>
//                         <input type="number" name="discountPercentage"  className="addProduct" />
                        
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="rating" className="block text-sm font-semibold">Rating</label>
//                         <input type="number"  required name="rating"  className="addProduct" />
                       
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="category" className="block text-sm font-semibold">Category</label>
//                         <input type="text" required name="category" className="addProduct" />
                       
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="thumbnail" className="block text-sm font-semibold">Thumbnail</label>
//                         <input type="text" required name="thumbnail" className="addProduct" />
                     
//                     </div>
//                     <div className="mb-4">
//                         <label htmlFor="images" className="block text-sm font-semibold">Images</label>
//                         <input type="text" name="images" className="addProduct" placeholder="Enter comma-separated URLs" />
//                     </div>
//                     <div className="mb-4">
//                     <button className="bg-red-500 w-full h-12 rounded-lg" type='submit' >ADD PRODUCT</button>
//                         {/* <button type="submit" className="bg-green-500 text-white px-4 py-2 rounded">Create Product</button> */}
